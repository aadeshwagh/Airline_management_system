...
public class login implements ActionListener {
    ...
    void check() throws Exception {
        ...
        if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(login, "Incorrect password/username", "Login status",
         ...
         * }
         * else{
         * JOptionPane.showMessageDialog(login, "Incorrect password", "Login status",
         * JOptionPane.ERROR_MESSAGE);
         * }
         * }
         * else{
         * JOptionPane.showMessageDialog(login, "Incorrect Username", "Login status",
         * JOptionPane.ERROR_MESSAGE);
         * }
         * 
         */
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == login) {
            try {
                ...
                JOptionPane.showMessageDialog(login, "Somthing went wrong", "Database error",
                        JOptionPane.ERROR_MESSAGE);
            }
